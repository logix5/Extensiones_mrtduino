...
Iot_thinkspeak::Iot_thinkspeak(String WriteAPI)
{
	apiKey=WriteAPI;
}

void Iot_thinkspeak::showResponse(int waitTime,bool logs){
    long t=millis();
    char c;
...
bool Iot_thinkspeak::thingSpeakWrite(unsigned int field,float value,bool logs ){
...
void Iot_thinkspeak::Reset_ESP8266(int wait_time,bool logs)
{
 ...
 void Iot_thinkspeak::Baudios_ESP8266(int baudios,int wait_time,bool logs)
 {
  ...
  void Iot_thinkspeak::Mode_ESP8266(unsigned int mode,int wait_time,bool logs)
 {
...
void Iot_thinkspeak::Credentials_ESP8266(String ssid,String password, int wait_time,bool logs)
 {
